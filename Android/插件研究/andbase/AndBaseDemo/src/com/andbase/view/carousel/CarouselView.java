...
public class CarouselView extends CarouselSpinner implements GestureDetector.OnGestureListener {
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
    	...
    	{
    		CarouselItemView view = (CarouselItemView)getAdapter().getView(j,null, null);
    		if(i == 0)
    			view.setDrawn(false);
    		sl.add((CarouselItemView)getAdapter().getView(j,null, null));
    	}
	...
	protected boolean getChildStaticTransformation(View child, Transformation transformation) {
		...
		mCamera.translate(((CarouselItemView)child).getItemX(), ((CarouselItemView)child).getItemY(), 
    ...
    private int getCenterOfGallery() {
        return (getWidth() - CarouselView.this.getPaddingLeft() - CarouselView.this.getPaddingRight()) / 2 + 
        	CarouselView.this.getPaddingLeft();
    }	
    ...
    void trackMotionScroll(float deltaAngle) {
        ...
        for(int i = 0; i < getAdapter().getCount(); i++){
        	...
        	CarouselItemView child = (CarouselItemView)getAdapter().getView(i, null, null);
