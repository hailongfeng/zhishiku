...
//    final String serverUri = "tcp://iot.eclipse.org:1883";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pahoMqttTest= new  PahoMqttTest(getApplicationContext(),new OnReceiveMsg(){
            @Override
            public void onReceiveMsg(String mainText) {
    ...
    interface OnReceiveMsg{
        void onReceiveMsg(String mainText);
    }
